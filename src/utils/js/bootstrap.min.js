...
!(function (t, e) {
  ...
  const i = e(t),
    ...
    d = (t) =>
      !(!l(t) || 0 === t.getClientRects().length) && 'visible' === getComputedStyle(t).getPropertyValue('visibility'),
    u = (t) =>
      !t ||
  ...
  class Ut {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Rt, ...('object' == typeof t ? t : {}) }).rootElement = c(t.rootElement)), h('backdrop', t, Ft), t
      );
    }
    _append() {
      this._isAppended ||
  ...
  class he extends R {
    ...
    _getConfig(t) {
      return (
        (t = { ...Jt, ...X.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), h(Gt, t, te), t
      );
    }
    _showElement(t) {
  ...
  class me extends R {
    ...
    _getConfig(t) {
      return (
        (t = { ...ue, ...X.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), h(de, t, ge), t
      );
    }
    _initializeBackDrop() {
      return new Ut({
