          ...
          <div className='row'>
              ...
              >
                <figure className='image'>
                  <NavLink to='/service-details'>
                    <img src={list_img1} alt='' />
                  </NavLink>
                </figure>
                <div className='inner-box '>
                  <i className='icon flaticon-solar-panel'></i>
                  <h4 className='title mt-0'>
                    <NavLink to='/service-details'>Hybrid Energy</NavLink>
                  </h4>
                  <div className='text'>
            ...
            <div className='col-xl-3 col-md-6'>
              ...
              >
                <figure className='image'>
                  <NavLink to='/service-details'>
                    <img src={list_img2} alt='' />
                  </NavLink>
                </figure>
                <div className='inner-box '>
                  <i className='icon flaticon-wind-turbine'></i>
                  <h4 className='title mt-0'>
                    <NavLink to='/service-details'>Wind Turbines</NavLink>
                  </h4>
                  <div className='text'>
                    Hybrid energy refers to the use of multiple sources of energy to meet our energy needs.
                  </div>
            ...
            <div className='col-xl-3 col-md-6'>
              ...
              >
                <figure className='image'>
                  <NavLink to='/service-details'>
                    <img src={list_img3} alt='' />
                  </NavLink>
                </figure>
                <div className='inner-box '>
                  <i className='icon flaticon-settings'></i>
                  <h4 className='title mt-0'>
                    <NavLink to='/service-details'>Maintenance</NavLink>
                  </h4>
            ...
            <div className='col-xl-3 col-md-6'>
              ...
              >
                <figure className='image'>
                  <NavLink to='/service-details'>
                    <img src={list_img4} alt='' />
                  </NavLink>
                </figure>
                <div className='inner-box '>
                  <i className='icon flaticon-windmill'></i>
                  <h4 className='title mt-0'>
                    <NavLink to='/service-details'>Wind Generators</NavLink>
                  </h4>
                  <div className='text'>
