          ...
          >
            <div className="inner-box">
              <div className="content-box">
                ...
                <div className="text">
                  Hybrid energy refers to the use of multiple sources ...
                </div>
                <a
                  href="https://kodesolution.com/html/2023/soluris-html/index.html"
                  className="read-more"
                >
          ...
          >
            <div className="inner-box">
              <div className="content-box">
                ...
                <div className="text">
                  Wind turbines are devices that convert wind energy ...
                </div>
                <a
                  href="https://kodesolution.com/html/2023/soluris-html/index.html"
                  className="read-more"
          ...
          >
            <div className="inner-box">
              <div className="content-box">
                ...
                <div className="text">
                  Wind generators are devices that harness the ...
                </div>
                <a
                  href="https://kodesolution.com/html/2023/soluris-html/index.html"
                  className="read-more"
          ...
          >
            <div className="inner-box">
              <div className="content-box">
                ...
                <div className="text">
                  A Solar PV (photovoltaic) system is a type of ...
                </div>
                <a
                  href="https://kodesolution.com/html/2023/soluris-html/index.html"
                  className="read-more"
